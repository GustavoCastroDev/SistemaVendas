<div class="caixa">
    ...
    <br>
    <a type="button" class="btn btn-primary" href="?pagina=novoCadastro"><i class="bi bi-plus"></i>Cadastrar Vendas</a>
    <br><br><br>
    <div>
        <table id="table_id" class="cell-border">
            ...
            <tbody>
                ...
                while ($linha = mysqli_fetch_array($consultaCadastros)) {
                    echo '<tr>';
                    echo '<td style="word-wrap: break-word">' . $linha['id'] . '</td>';
                    echo '<td style="word-wrap: break-word">' . $linha['nome_produto'] . '</td>';
                    echo '<td style="word-wrap: break-word">' . $linha['nome_cliente'] . '</td>';
